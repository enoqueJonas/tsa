...
const valuesAndTypesBlocks: LessonBlock[] = [
    ...
    { type: "callout", tone: "note", title: "Why this matters", body: "A future service-registration request may arrive as JSON containing a service name, lifecycle state, criticality, owning team and optional technical owner. Those bytes do not become trustworthy domain data merely because Python can represent them. Parsing, type conversion and validation are different responsibilities." },
    ...
    { type: "callout", tone: "note", title: "Think ahead to the API", body: "When Django REST Framework arrives, serializers will help parse and validate incoming service-registry representations. The framework does not replace this mental model. It gives us a boundary at which to apply it consistently." },

...
const blocks: LessonBlock[] = [
    ...
    { type: "paragraph", text: "Python is happy with all five assignments above, but that only tells us the values are valid Python objects. It says nothing about Steward's rules. For example, 'extremely-important' is a perfectly good str. If Steward accepts only low, medium, high and critical, the domain still has to reject it." },
    ...
    { type: "paragraph", text: "Numbers show up quickly in Steward: a review every 90 days, three open risks, or a 99.9% availability target. Those values are all numeric, but they do not mean the same thing. Choose int or float because it fits the value you are modelling, not simply because both can participate in arithmetic." },

...
import { distributedTracingImplementationDeepLessons } from "./reliability-distributed-tracing-implementation-deep";
...
export const observability: LearningPath = { id: "observability", title: "Observability", lessons: [...observabilityDeepLessons, tracingBackendDecisionLesson] };
export const distributedTracing: LearningPath = { id: "distributed-tracing", title: "Distributed Tracing with OpenTelemetry and Tempo", lessons: distributedTracingImplementationDeepLessons };
export const productionLogging: LearningPath = { id: "logging", title: "Production Logging", lessons: [...productionLoggingDeepLessons, centralLoggingDecisionLesson] };

...
__turbopack_context__.s([]);
(()=>{
    const e = new Error("Cannot find module './first-activity'");
...
(()=>{
    const e = new Error("Cannot find module './activities/first-activity'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__02wo31e._.js.map